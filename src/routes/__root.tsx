...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MySocLabs Attendance System" },
      { name: "description", content: "Attendance management for MySocLabs internship and training center." },
...
function RootComponent() {
  ...
  useEffect(() => {
    // Auth state change listener disabled for dev bypass
  }, [router, queryClient]);
